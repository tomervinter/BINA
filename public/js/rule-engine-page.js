  ...
  { type: 'salesPattern', title: 'זיהוי דפוס מכירות לקוח — תובנה 1',
    subrules: [
      { title: 'מגמה חודשית',
        ...
        detail: 'נדרש מחזור בסיס של {monthly_minBaseRevenue}₪. מוצג המוצר שתרם הכי הרבה לירידה. חומרה גבוהה מעל {monthly_highPct}%. החודש הנוכחי (אם עדיין באמצעו) אינו נכלל בהשוואה — כך שאין ירידה מדומה רק בגלל שהחודש טרם הסתיים. ירידה שמוסברת ע"י חג/עונה קרובים אינה מופקת כתובנה (ראו הגדרה כללית 8), ועלייה במחזור אינה מופקת כתובנה (ראו הגדרה כללית 7).' },
      { title: 'מגמה רבעונית',
  ...
  { type: 'purchasePattern', title: 'דפוס רכישה של לקוח — תובנה 2',
    subrules: [
      { title: 'ירידה בכמות מוצר',
        ...
        detail: 'נדרשת כמות בסיס של {productQty_minPriorQty}+ יחידות בתקופה הקודמת. מוצר עם תחליף מוגדר נספר יחד עם התחליף שלו כיחידה אחת. החודש הנוכחי (אם עדיין באמצעו) אינו נכלל בחלון. ירידה שמוסברת ע"י חג/עונה קרובים אינה מופקת כתובנה (ראו הגדרה כללית 8). חומרה גבוהה מעל {productQty_highPct}%.' },
