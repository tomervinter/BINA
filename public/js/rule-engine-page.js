...
const INSIGHT_RULES = [
  ...
  { type: 'weeklyProductBreak', title: 'שבירת דפוס שבועי', rule: 'לקוח פעיל שרכש מוצר (פעיל) ב-{weekly_establishedWeeksNeeded}+ מתוך {weekly_totalWeeksChecked} השבועות האחרונים, ולא רכש אותו השבוע הנוכחי — אלא אם למוצר מוגדר מלאי 0 בטבלת המלאי, ואז התובנה מדוכאת (אין מה למכור). חומרה גבוהה מעל {weekly_highWeeksNeeded} שבועות.' },
